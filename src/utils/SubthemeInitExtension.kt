...
fun Subtheme.initWithJson(json: String, ctx: ObjectContext) {
    ...
    this.theme = ObjectSelect.query(Theme::class.java).where(Theme.NAME.eq(jsonAsMap["theme"])).selectFirst(ctx)
}