...
public abstract class _Task extends BaseDataObject {
    ...
    public void setSubtheme(Integer subtheme) {
        beforePropertyWrite("subtheme", this.subtheme, subtheme);
        this.subtheme = subtheme;
    }

    public Integer getSubtheme() {
        beforePropertyRead("subtheme");
    ...
    public void writePropertyDirectly(String propName, Object val) {
        ...
        switch (propName) {
            ...
            case "explanation":
                ...
                break;
            case "subtheme":
                this.subtheme = (Integer)val;
                break;
            case "author":
                this.author = (Integer)val;
                break;
            case "solutions":
                this.solutions = val;
                break;
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.subtheme = (Integer)in.readObject();
